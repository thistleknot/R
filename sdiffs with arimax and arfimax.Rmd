...
#whitening::whiten(subset[,c(colnames(newDF_t) %notin% c(var_of_int))])

#whitening::whiteningMatrix(as.matrix(subset[,c(colnames(newDF_t) %notin% c(var_of_int))]), method=c("ZCA"))
